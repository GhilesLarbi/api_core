...
import {
  useAdminSessions,
  useLogoutAdminSessions,
} from '@/services/use-admin-auth'
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
type Pending = { type: 'one'; session: AdminSession } | { type: 'all' } | null
...
export function ConnectedDevicesView({ onBack }: { onBack: () => void }) {
  ...
  const sessions = useAdminSessions({ page: 1, size: 100 })
  const logoutSessions = useLogoutAdminSessions()
