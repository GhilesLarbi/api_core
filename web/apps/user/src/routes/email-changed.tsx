          ...
          {success ? (
            <>
              ...
              <h1 className='text-2xl font-semibold tracking-tight'>
                {t('verify.emailChangedTitle')}
              </h1>
              <p className='text-muted-foreground text-sm'>
                {t('verify.emailChangedBody')}
              </p>
            ...
            <>
              ...
              <h1 className='text-2xl font-semibold tracking-tight'>
                {t('verify.emailChangeFailedTitle')}
              </h1>
              <p className='text-muted-foreground text-sm'>
                {t('verify.emailChangeFailedBody')}
              </p>
              <Button variant='outline' asChild className='mt-3'>
                <Link to='/settings/email'>{t('verify.tryAgain')}</Link>
              </Button>
            </>
          )}
        </Container>
